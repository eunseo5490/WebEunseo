...
public class MethodExample {
	...
	//반지름은 외부에서 전달받는다.
	//원의 둘레 : 2 * 3.14 * 반지름
	//메서드 내부에서 둘레를 구하고 풀력한 다음 종료

	public void circleRound(double r) {
		System.out.println("원의 둘레 : "+((int)(2*3.14*r)));
	...
	*/
	...
	//문자열에서 해당 문자가 몇 번 등장하는지 반환하는 countChar메서드 작성하기
	
	public int countChar(String sentence, char letter) {
		int sum = 0;
        ...
        System.out.println("글자 "+letter+"의 개수: " + sum);
